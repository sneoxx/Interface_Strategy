...
public class Main {
    ...
    class PathFinder{
        ...
        // создаем массив fillmap типа int 10*10 и заполняем нулями
        int[][] fillmap = new int[10][10]; // Pазмеp == pазмеpу лабиpинта !
        // создаем массив labyrinth типа int
        int[][] labyrinth;
        // создаем автоматически расширяемый массив buf
        ...
        PathFinder(int[][] labyrinth){
	     ...
	     // фунция проверки точки, короче ли путь к ней. Если короче запоманием точку в массив buf. На входе точка и величина пути найденнная раннее
        ...
        //метод возвращает точку из массива buf
        Point pop(){
        ...
        public static void main(String[] args){
            ...
            //выведем в цикле путь на печать
            for(Point p: path)
